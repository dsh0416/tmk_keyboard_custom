// Generated by TKG at 2016-08-25 15:58:15
...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    [1] = KEYMAP_TKG(
        ...
        CAPS,MRWD,MPLY,MFFD,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,DEL,  \
        TRNS,VOLD,MUTE,VOLU,TRNS,TRNS,LEFT,DOWN,RGHT,UP,  PGDN,PGUP,     HOME, \
        LSFT,     FN2, FN3, FN4, TRNS,TRNS,TRNS,PPLS,PMNS,PAST,PSLS,     RSFT, \
        TRNS,LALT,LGUI,          SPC,                     RGUI,RALT,ESC, TRNS),
    [2] = KEYMAP_TKG(
        TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS, \
        TRNS,7,   8,   9,   TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS, \
        TRNS,4,   5,   6,   TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,     END,  \
        TRNS,     1,   2,   3,   0,   TRNS,TRNS,TRNS,TRNS,TRNS,UP,       TRNS, \
