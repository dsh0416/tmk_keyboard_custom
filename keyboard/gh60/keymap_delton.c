// Generated by TKG at 2016-05-14 13:05:58
...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    [1] = KEYMAP_TKG(
        ...
        LCTL,VOLD,MUTE,VOLU,TRNS,TRNS,LEFT,DOWN,RGHT,UP,  PGDN,PGUP,     HOME, \
    ...
    [2] = KEYMAP_TKG(
        ...
        TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,4,   5,   6,   TRNS,TRNS,     END,  \
        TRNS,     TRNS,TRNS,TRNS,TRNS,TRNS,0,   1,   2,   3,   UP,       TRNS, \
